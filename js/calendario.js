...
openModalHTML.addEventListener('click', (e) => { e.preventDefault(); modalHTML.classList.add('modal--show'); });
openModalJS.addEventListener('click', (e) => { e.preventDefault(); modalJS.classList.add('modal--show'); });
